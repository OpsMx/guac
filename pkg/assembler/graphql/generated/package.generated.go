...
func (ec *executionContext) _PackageVersion_applicationDetails(ctx context.Context, field graphql.CollectedField, obj *model.PackageVersion) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOApplicationDetails2ᚕᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐApplicationDetailsᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNApplicationDetails2ᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐApplicationDetails(ctx context.Context, sel ast.SelectionSet, v *model.ApplicationDetails) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalOApplicationDetails2ᚕᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐApplicationDetailsᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.ApplicationDetails) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNApplicationDetails2ᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐApplicationDetails(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
